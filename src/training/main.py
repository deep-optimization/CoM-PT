...
from open_clip import create_model_and_transforms, trace_model, get_tokenizer, DataAugmentationDINO
...
def main(args):
    ...
    # preprocess_train = DataAugmentationDINO((0.4,1.0), (0.05, 0.4), 6)
    # assert 0 == 1
