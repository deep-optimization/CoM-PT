...
NCCL_P2P_DISABLE=1 torchrun --nproc_per_node 8 -m \
    ...
    --model ViT-L-16 \
    --t-model ViT-B-16 \
    --t-model-checkpoint /mnt/workspace/code/CoM/src/logs/2025_04_29-02_59_44-t_model_ViT-S-16-s_model_ViT-B-16-lr_0.001-b_128-tag_com/checkpoints/com_vit-b_e16.pth \
    --logs logs/ \
    --alpha_fd_loss 500. \
    --weight-init True \
    --differ-width True \
